...
Route::group(['prefix' => 'books'], function () {
    ...
    Route::post('', 'BookController@filter')->name('book.filter');
    Route::get('author-filter/{author_id}', 'BookController@showByAuthor')->name('book.filter.author');
    Route::get('publisher-filter/{book_id}', 'BookController@showByPublisher')->name('book.filter.publisher');
